...
func GetUserIncludeProfile(id uuid.UUID) (*UserResponse, error) {
	return nil, nil
}

func GetUserIncludeOrderBy(id uuid.UUID) (*UserResponse, error) {
	return nil, nil
}

func GetuUserIncludeCart(id uuid.UUID) (*UserResponse, error) {
	return nil, nil
}
